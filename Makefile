...
DATA		= pgnodemx--1.0--1.1.sql pgnodemx--1.1--1.2.sql pgnodemx--1.2--1.3.sql pgnodemx--1.3--1.4.sql pgnodemx--1.4--2.0.sql pgnodemx--2.0.sql pg_proctab--0.0.10-compat.sql
